...
stats.dir <- "/home/sticklegroup/meta/SB_meta_data/fst_dxy/loose_filter"
out.dir <- "/home/sticklegroup/meta/SB_meta_data/fst_dxy/loose_filter/combined"

#read in file names
filenames <- list.files(stats.dir, pattern="*stats.txt$", recursive = TRUE, full.names = TRUE)
...
out.file.name <- file.path(out.dir, paste("stats_master_variant_loose", date.stamp, ".txt", sep = ""))
