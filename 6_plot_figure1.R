...
figure_3_plot <- plot_grid(rep_plot, avg_reg_plot, NULL,fst_relaxed, align = "hv", ncol = 2, rel_heights = c(1,1))

save_plot("figures/Figure3_grid_raw.pdf", figure_3_plot, base_height = 8.5, base_width = 8.5)

# Figure3_grid_raw.pdf & Figure3_rep.pdf are then combined/cleaned up manually in illustrator 
